      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../teacher/teacher_grade.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'teacher_grade.php' || basename($_SERVER['PHP_SELF']) == 'teacher_view_grade.php' || basename($_SERVER['PHP_SELF']) == 'teacher_edit_grade.php' || basename($_SERVER['PHP_SELF']) == 'teacher_encode_grade.php') ? 'active' : ''; ?>">
